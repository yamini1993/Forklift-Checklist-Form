...
class Email{
	...
	public $to = 'safety@accudyn.com, yograjgharat@gmail.com'; 
	public $subject = '';
	public $from = 'admin@accudyn.com';
	public $message = '';
	public $forkliftName;
	public $driverName;
	
	/*	Function to send automatic email for a shift is comebody misses to fill the form in 4 hours
	*/
	function shift4HourFailEmail($f, $u, $sh, $dt, $mn, $ye){
		$this->to = 'supervisors@accudyn.com, yograjgharat@gmail.com';
		$this->subject = 'Forklift Checklist Alert: Forms Not Submitted.';
		$this->forkliftName = $f;
		$this->driverName = $u;
		$this->message = 'Form for '.$f.' was not submitted by '.$u.' for Shift'.$sh;
		$this->createMessage($dt, $mn, $ye, $sh);
		$this->send();
	}
	
	/*	Send Email on successfull form submission
	*/
	function successEmail(){
	
	}
	
	/*	Send Email on Problem with any Case
	*/
	function problemEmail($f,$u,$dt,$mn,$ye,$sh,$s, $m){
	$this->subject = $s;
	$this->forkliftName = $f;
	$this->driverName = $u;
	$this->message = $m;
	...
	*/
	function send(){
		...
		// More headers
		$headers .= 'From: '.$this->driverName.'<'.$this->from.'>' . "\r\n";
		

		mail($this->to,$this->subject,$this->message,$headers);
	}
	
	/*	Function to create body / message of the email
	*/
	function createMessage($dt, $mn, $ye, $sh){
		$this->message = '<!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office"><head>
    <!--[if gte mso 9]><xml>
...
<body class="clean-body" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: #FFFFFF">
  ...
  <table class="nl-container" style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 320px;Margin: 0 auto;background-color: #FFFFFF;width: 100%" cellpadding="0" cellspacing="0">
	...
	<div style="color:#555555;line-height:200%;font-family:Arial, Helvetica, sans-serif; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">	
		<div style="font-size:12px;line-height:24px;color:#555555;font-family:Arial, Helvetica, sans-serif;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 28px;text-align: center"><strong><span style="font-size: 16px; line-height: 32px;">'.$this->forkliftName.'&#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; Shift # '.$sh.'&#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; '.$mn.'-'.$dt.'-'.$ye.' </span></strong></p></div>	
	</div>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="divider " style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 100%;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
	...
	<div style="color:#555555;line-height:120%;font-family:Arial, Helvetica, sans-serif; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">	
		<div style="font-size:12px;line-height:14px;color:#555555;font-family:Arial, Helvetica, sans-serif;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 17px"><span style="font-size: 18px; line-height: 21px;"><strong>'.$this->subject.'</strong></span></p></div>	
	</div>
	<!--[if mso]></td></tr></table><![endif]-->
</div>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="divider " style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 100%;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
	...
	<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;"><![endif]-->
	<div style="color:#555555;line-height:120%;font-family:Arial, Helvetica, sans-serif; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">	
		<div style="font-size:12px;line-height:14px;color:#555555;font-family:Arial, Helvetica, sans-serif;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 17px"><span style="line-height: 19px; font-size: 16px;">Sender : '.$this->driverName.'</span><br><br><span style="line-height: 19px; font-size: 16px;">'.$this->message.'</span></p></div>	
	</div>
	<!--[if mso]></td></tr></table><![endif]-->
</div>
